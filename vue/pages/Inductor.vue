        ...
        <div class="calc-result">
            <div class="calc-result-card">
                <div class="calc-result-inner">
                    ...
                    <div v-else>
                        <div class="calc-result-value">最小电感: <span class="calc-result-number">{{ minInductanceDisplay
                                }}</span>
                            <span class="calc-result-unit">uH</span>
                        </div>
                        <div class="calc-result-value">推荐电感: <span class="calc-result-number">{{
                            recommendedInductanceDisplay }}</span>
                            <span class="calc-result-unit">uH</span>
                        </div>
                        <div class="calc-result-value">峰值电流: <span class="calc-result-number">{{ peakCurrentDisplay
                                }}</span>
...
const error = computed(() => {
    if (vin.value === null || vout.value === null || iout.value === null || freq.value === null || ripplePctPercent.value === null) return '请填写所有字段';
